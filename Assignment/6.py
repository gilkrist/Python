# QUESTION:
# Create a simple password manager system using functions that allows users to securely add, 
# edit, delete, and retrieve passwords. The system should include a login functionality 
# with a limit of 3 attempts and keep track of failed password attempts.
